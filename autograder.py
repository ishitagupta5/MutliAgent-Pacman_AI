...
def evaluate(generate_solutions, test_root, module_dict, exception_map=ERROR_HINT_MAP,
    ...
    grades = grading.Grades(project_params.PROJECT_NAME, questions, gs_output=gs_output, edx_output=edx_output, mute_output=mute_output)
    if question_to_grade == None:
...
if __name__ == '__main__':
    ...
    if options.run_test != None:
        ...
        evaluate(options.generate_solutions, options.test_root, module_dict, gs_output=options.gs_output,
